        ...
        <Card className="glass-card animate-fade-in">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" className="glass-button" onClick={() => signInWithProvider('google')}>
              ...
              <Button variant="outline" className="glass-button" onClick={() => signInWithProvider('github')}>
