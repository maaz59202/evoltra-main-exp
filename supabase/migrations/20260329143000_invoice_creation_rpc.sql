...
grant execute on function public.generate_unique_invoice_number() to authenticated;
grant execute on function public.create_invoice_with_items(uuid, uuid, uuid, date, text, numeric, text, jsonb) to authenticated;
